...
## 4. State of play
- 22 services build, run and are monitored; web app has 19 test files / 129 tests; repository live
  and pushed to `main`. Runs natively on Linux and macOS from `./bootstrap.sh`.

## 5. Open items
1. Flutter mobile apps on the new APIs.
2. The verification regime: unit, integration, functional, SAST, DAST, WCAG, OWASP Top 10.
