...
export function buildAppModule(env: Env, principalResolver?: Provider) {
  @Module({ imports: [KitModule.forRoot({ env, principalResolver })], controllers: [CompaniesController, PortFacilitiesController, DirectoryController, AccreditationController], providers: [FacilitiesConsumer] })
  class AppModule {}
  return AppModule;
}
