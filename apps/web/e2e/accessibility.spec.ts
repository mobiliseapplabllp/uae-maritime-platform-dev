...
const STATIC_ROUTES = [
  ...
  '/ops/overview', '/legislation/overview', '/companies/overview', '/services/overview', '/services', '/services/requests', '/services/studio', '/masters/overview', '/admin/overview', '/agents', '/agents/decisions', '/agents/escalations', '/agents/assurance', '/agents/gateway', '/agents/models',
...
async function detailRoutes(page: Page): Promise<string[]> {
  ...
  return [
    ...
    ...await one('/facilities/port-facilities?limit=1', (id) => `/port-facilities/${id}`),
