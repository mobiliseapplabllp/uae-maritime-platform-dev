...
export const ROUTES: RouteDef[] = [
  ...
  { path: '/masters/overview', perm: 'masters.view', element: L(() => import('../pages/masters/DataStudioDashboard')) },
  ...
  { path: '/admin/overview', perm: 'users.view', element: L(() => import('../pages/admin/AdminDashboard')) },
  ...
  { path: '/services/overview', perm: 'services.view', element: L(() => import('../pages/services/ServiceDeskDashboard')) },
  { path: '/services', perm: 'services.view', element: L(() => import('../pages/services/ServiceCatalogue')) },
  { path: '/services/requests', perm: 'services.view', element: L(() => import('../pages/services/ApplicationsRegister')) },
  { path: '/services/requests/:id', perm: 'services.view', element: L(() => import('../pages/services/ApplicationDetail')) },
  { path: '/services/studio', perm: 'services.view', element: L(() => import('../pages/services/ServiceStudio')) },
  { path: '/services/:key', perm: 'services.view', element: L(() => import('../pages/services/ServiceDetail')) },
