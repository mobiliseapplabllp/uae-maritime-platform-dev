...
export const TERM_COLOR: Record<string, string> = { CONTAINER: '#0797A5', BULK: '#9C6412', MULTIPURPOSE: '#3B6FB6', LIQUID: '#BD3861', RORO: '#75479C', SPM: '#2C6E52', COAL: '#5A4632' };
...
export const KIND_META: Record<ScheduleKind, { label: string; color: string }> = {
  ARRIVAL: { label: 'Arrival', color: '#0B74B0' }, BERTHING: { label: 'Berthing', color: '#0797A5' }, SAILING: { label: 'Sailing (planned)', color: '#9C6412' }, SAILED: { label: 'Sailed', color: '#5A6B78' },
};
