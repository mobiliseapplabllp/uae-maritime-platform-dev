...
export interface LegalInstrument {
  id: string; refNo: string; title: string; titleAr?: string; type: LegalInstrumentType; category: string; status: InstrumentStatus; issuedBy: string; issuedDate: string; effectiveDate?: string | null;
