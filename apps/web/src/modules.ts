...
export const MODULES: ModuleDef[] = [
  ...
  { key: 'ops', name: 'Harbour Operations', short: 'Harbour', color: '#06737E', desc: 'Vessel calls, quay view, day schedule, berthing and marine craft', icon: ViewTimelineRoundedIcon, perm: 'portcalls.view', home: '/ops/overview',
    nav: [{ header: 'Marine operations', items: [
      { to: '/ops/overview', label: 'Harbour Dashboard', icon: SpaceDashboardRoundedIcon, perm: 'portcalls.view', end: true },
  ...
  { key: 'crew', name: 'Crew & Manning', short: 'Crew', color: '#75479C', desc: 'Crew records — competency, medicals and sea service', icon: GroupsRoundedIcon, perm: 'seafarers.view', home: '/seafarers/overview',
  ...
  { key: 'legis', name: 'Notices & Circulars', short: 'Notices', color: '#8A5A2B', desc: 'Acts, rules, notices and circulars — with acknowledgments', icon: CampaignRoundedIcon, perm: 'legislation.view', home: '/legislation/overview',
    nav: [{ header: 'Instruments', items: [{ to: '/legislation/overview', label: 'Notices Dashboard', icon: SpaceDashboardRoundedIcon, perm: 'legislation.view', end: true }, { to: '/legislation', label: 'Notice Library', icon: GavelRoundedIcon, perm: 'legislation.view', end: true }, { to: '/legislation/imo', label: 'IMO Watch', icon: TravelExploreRoundedIcon, perm: 'legislation.view' }] }] },
  { key: 'incidents', name: 'Incident Desk', short: 'Incidents', color: '#B3452E', desc: 'HSE & marine incident case files — response, RCA and closure', icon: CrisisAlertRoundedIcon, perm: 'incidents.view', home: '/incidents/overview',
  ...
  { key: 'inspect', name: 'Survey & Audit Cell', short: 'Surveys', color: '#8A5810', desc: 'PSC, FSI, ISM, ISPS and MLC surveys with findings and targeting', icon: FactCheckRoundedIcon, perm: 'inspections.view', home: '/inspections/overview',
  ...
  { key: 'facil', name: 'Port Companies', short: 'Companies', color: '#2C6E52', desc: 'The company directory and licensing of everyone working in the port', icon: CorporateFareRoundedIcon, perm: 'facilities.view', home: '/companies/overview',
    nav: [{ header: 'Companies', items: [
      { to: '/companies/overview', label: 'Companies Dashboard', icon: SpaceDashboardRoundedIcon, perm: 'facilities.view', end: true },
      { to: '/companies', label: 'Company Directory', icon: CorporateFareRoundedIcon, perm: 'facilities.view', end: true },
  ...
  { key: 'services', name: 'Service Desk', short: 'Services', color: '#0E7C86', desc: 'The catalogue of maritime services, applications and the Service Studio', icon: StorefrontRoundedIcon, perm: 'services.view', home: '/services/overview',
    nav: [{ header: 'Services', items: [
      { to: '/services/overview', label: 'Service Desk Dashboard', icon: SpaceDashboardRoundedIcon, perm: 'services.view', end: true },
  ...
  { key: 'finance', name: 'Revenue & Billing', short: 'Revenue', color: '#BD3861', desc: 'Invoicing, tariffs and collections', icon: ReceiptLongRoundedIcon, perm: 'invoices.view', home: '/invoices/overview',
    nav: [{ header: 'Billing', items: [
      { to: '/invoices/overview', label: 'Revenue Dashboard', icon: SpaceDashboardRoundedIcon, perm: 'invoices.view', end: true },
      { to: '/invoices', label: 'Invoices', icon: ReceiptLongRoundedIcon, perm: 'invoices.view', end: true },
  ...
  { key: 'masters', name: 'Data Studio', short: 'Masters', color: '#5A6B78', desc: 'Berth master, lookups and checklist templates', icon: HubRoundedIcon, perm: 'masters.view', home: '/masters/overview',
    nav: [{ header: 'Reference data', items: [
      { to: '/masters/overview', label: 'Data Quality Dashboard', icon: SpaceDashboardRoundedIcon, perm: 'masters.view', end: true },
  ...
  { key: 'admin', name: 'Administration', short: 'Admin', color: '#0A2239', desc: 'Users, roles, audit log and settings', icon: AdminPanelSettingsRoundedIcon, perm: 'users.view', home: '/admin/overview',
    nav: [{ header: 'Administration', items: [
      { to: '/admin/overview', label: 'Access Dashboard', icon: SpaceDashboardRoundedIcon, perm: 'users.view', end: true },
