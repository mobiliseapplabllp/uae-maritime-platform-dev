...
export const INDIA: JurisdictionProfile = {
  ...
  registry: {
    ...
    portsOfRegistry: [
      { code: 'KDL', name: 'Kandla', region: 'Gujarat', default: true }, { code: 'MUM', name: 'Mumbai', region: 'Maharashtra' },
      ...
      { code: 'VTZ', name: 'Visakhapatnam', region: 'Andhra Pradesh' }, { code: 'JAM', name: 'Jamnagar', region: 'Gujarat' },
