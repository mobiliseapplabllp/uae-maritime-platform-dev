...
export const LOOKUP_CATEGORIES: LookupCategory[] = [
  ...
  { key: 'seafarerRank',   label: 'Seafarer Ranks', labelAr: 'رتب البحارة', group: 'Seafarers & MET', desc: 'Ranks on the crew register and the FAL-5 crew list', metaFields: [MF('department', 'Department', 'القسم', 'select', { options: ['DECK', 'ENGINE', 'CATERING', 'OTHER'] }), MF('officer', 'Officer rank', 'رتبة ضابط', 'boolean'), MF('order', 'Sort order', 'ترتيب العرض', 'number')] },
  { key: 'seafarerCertType', label: 'Seafarer Certificates', labelAr: 'شهادات البحارة', group: 'Seafarers & MET', desc: 'Certificates and documents a seafarer carries', metaFields: [MF('convention', 'Convention / regulation', 'الاتفاقية'), MF('validityMonths', 'Validity (months)', 'مدة الصلاحية (أشهر)', 'number'), MF('mandatory', 'Required to sign on', 'مطلوب للالتحاق', 'boolean')] },
  ...
  // legislation
  { key: 'legalInstrumentType', label: 'Legal Instrument Types', labelAr: 'أنواع الصكوك التشريعية', group: 'Legislation', desc: 'Acts, rules, circulars, notices, orders and conventions', metaFields: [MF('citable', 'Shown on the public portal', 'يُعرض على البوابة العامة', 'boolean'), MF('refPrefix', 'Reference prefix', 'بادئة المرجع')] },
