...
export function buildSettings(profile: string): WorldSetting[] {
  ...
  return [
    ...
    { key: 'billing', value: { taxName: j.tax.name, taxRate: j.tax.ratePct, taxRegistrationLabel: j.tax.registrationLabel, placeOfSupply: ae ? 'Abu Dhabi' : 'Maharashtra', serviceCode: ae ? '996751' : '996751', invoicePrefix: j.tax.invoicePrefix, paymentTermsDays: 30, currency: j.currency.code } },
