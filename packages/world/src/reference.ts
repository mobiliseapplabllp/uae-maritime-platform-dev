...
export function buildLookups(profile: string): WorldLookup[] {
  ...
  const ranks: [string, string, string, string, boolean, number][] = [ // code, label, Arabic, department, officer, order
    ...
    ['CHIEF_ENGINEER', 'Chief Engineer', 'كبير المهندسين', 'ENGINE', true, 5], ['SECOND_ENGINEER', 'Second Engineer', 'المهندس الثاني', 'ENGINE', true, 6], ['THIRD_ENGINEER', 'Third Engineer', 'المهندس الثالث', 'ENGINE', true, 7], ['FOURTH_ENGINEER', 'Fourth Engineer', 'المهندس الرابع', 'ENGINE', true, 8],
    ['ETO', 'Electro-Technical Officer', 'ضابط كهروتقني', 'ENGINE', true, 9], ['BOSUN', 'Bosun', 'رئيس البحارة', 'DECK', false, 10], ['AB', 'Able Seaman', 'بحار مؤهل', 'DECK', false, 11], ['OS', 'Ordinary Seaman', 'بحار عادي', 'DECK', false, 12],
  ...
  ranks.forEach(([c, l, ar, dept, officer, order]) => out.push(lk('seafarerRank', c, l, { department: dept, officer, order }, ar)));
  push('seafarerCertType', [
    ['COC', 'Certificate of Competency', 'شهادة الكفاءة', { convention: 'STCW II/III', validityMonths: 60, mandatory: true }], ['GOC', 'GMDSS GOC', 'شهادة مشغل GMDSS عام', { convention: 'STCW IV/2', validityMonths: 60, mandatory: false }],
    ['MEDICAL', 'Medical Fitness (ILO/MLC)', 'اللياقة الطبية', { convention: 'MLC 2006 / STCW I/9', validityMonths: 24, mandatory: true }], ['BST', 'STCW Basic Safety Training', 'التدريب الأساسي على السلامة', { convention: 'STCW VI/1', validityMonths: 60, mandatory: true }],
    ['AFF', 'Advanced Fire Fighting', 'مكافحة الحريق المتقدمة', { convention: 'STCW VI/3', validityMonths: 60, mandatory: false }], ['MFA', 'Medical First Aid', 'الإسعافات الأولية الطبية', { convention: 'STCW VI/4', validityMonths: 60, mandatory: false }],
    ['SSO', 'Ship Security Officer', 'ضابط أمن السفينة', { convention: 'STCW VI/5', validityMonths: 60, mandatory: false }], ['TANKER_FAM', 'Tanker Familiarisation', 'التعريف بالناقلات', { convention: 'STCW V/1', validityMonths: 60, mandatory: false }],
    ['CDC', 'Certificate of Discharge (CDC)', 'دفتر خدمة البحار', { convention: 'National', validityMonths: 120, mandatory: true }], ['FSE', 'Flag State Endorsement', 'اعتماد دولة العلم', { convention: 'STCW I/10', validityMonths: 60, mandatory: false }],
    ['SEAMAN_CARD', 'Seafarer Identity Card', 'بطاقة هوية البحار', { convention: 'ILO 185', validityMonths: 60, mandatory: false }]]);
  ...
  push('legalInstrumentType', [['ACT', 'Federal law / Act', 'قانون اتحادي', { citable: true, refPrefix: 'FL' }], ['RULES', 'Rules / regulations', 'لائحة', { citable: true, refPrefix: 'REG' }], ['CIRCULAR', 'Circular', 'تعميم', { citable: true, refPrefix: 'CIR' }], ['NOTICE', 'Marine notice', 'إشعار بحري', { citable: true, refPrefix: 'MN' }],
    ['ORDER', 'Ministerial order', 'قرار وزاري', { citable: true, refPrefix: 'MO' }], ['CONVENTION', 'Convention', 'اتفاقية', { citable: true, refPrefix: 'CONV' }], ['GUIDANCE', 'Guidance note', 'مذكرة إرشادية', { citable: true, refPrefix: 'GN' }], ['INTERNAL', 'Internal instruction', 'تعليمات داخلية', { citable: false, refPrefix: 'INS' }]]);
